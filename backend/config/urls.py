...
def forbid_private_audio_access(_request, _path):
...
urlpatterns = [
    ...
    # Private dream audio files must never be served directly via MEDIA_URL.
    path('media/reves_audio/<path:_path>', forbid_private_audio_access),
] 
